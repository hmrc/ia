...
lazy val scoverageSettings = {
  ...
  Seq(
    ...
    ScoverageKeys.coverageExcludedFiles := ".*EnumFormat.*;.*microserviceGlobal.*;.*microserviceWiring.*;.*ApplicationLoader.*;.*ApplicationConfig.*;.*package.*;.*Routes.*;.*TestOnlyController.*;.*WebService.*",
...
lazy val microservice = Project(appName, file("."))
  ...
  .settings(PlayKeys.playDefaultPort := 8051)
